...
export const createFolder = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // check if folder with same name already exists int this parent folder
    const existing = files.find(
...
export const renameFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // check if the file with the new same name existing in the same parent folder
...
export const deleteFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const deleteRecursive = async (fileId: Id<"files">) => {
      ...
      // if it's a folder delete everything
      if (item.type === "folder") {
